...
class RvDecoration : RecyclerView.ItemDecoration() {
    ...
    private val colorActive = Color.parseColor("#1255D5")
    private val colorInactive = Color.parseColor("#F0F0F0")
    ...
    override fun onDrawOver(c: Canvas, parent: RecyclerView, state: RecyclerView.State) {
        ...
        val indicatorPosY = parent.height - mIndicatorHeight / 2.25f
        ...
        val progress = mInterpolator.getInterpolation(left * -0 / width.toFloat())
